  ...
  return (
    <div className="min-h-screen bg-slate-50 font-['Inter',sans-serif] text-slate-800">
      ...
      <section id="courses" className="relative py-24 bg-white overflow-hidden">
        ...
        <div className="absolute top-32 right-32 w-72 h-72 bg-blue-600/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-32 left-32 w-80 h-80 bg-violet-600/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
      ...
      <section className="relative py-24 bg-slate-50 overflow-hidden">
        {/* Floating background elements */}
        <div className="absolute top-20 left-20 w-96 h-96 bg-blue-600/8 rounded-full blur-3xl animate-pulse delay-500"></div>
        <div className="absolute bottom-20 right-20 w-64 h-64 bg-violet-600/8 rounded-full blur-3xl animate-pulse delay-1500"></div>
      ...
      <section className="relative py-24 bg-slate-50 overflow-hidden">
        {/* Floating background elements */}
        <div className="absolute top-40 right-16 w-80 h-80 bg-blue-600/6 rounded-full blur-3xl animate-pulse delay-700"></div>
        <div className="absolute bottom-40 left-16 w-72 h-72 bg-violet-600/6 rounded-full blur-3xl animate-pulse delay-300"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {memberships.map((plan, index) => (
              <div key={index} className={`bg-white rounded-3xl border p-8 relative transition-all duration-300 hover:shadow-xl hover:shadow-slate-900/5 ${plan.popular
                ...
                <a href={plan.tagmangoUrl} className={`block w-full py-4 px-6 rounded-2xl text-center font-semibold transition-all duration-200 ${plan.popular
